...
class AlgorithmVersion(Base):
    ...
    github_repo_owner = Column(String(128), nullable=True)
    github_repo_name = Column(String(128), nullable=True)
    github_parameter_path = Column(String(512), nullable=True)
    github_ref = Column(String(256), nullable=True)
...
class TrainingResult(Base):
    ...
    is_dashboard_latest = Column(Boolean, nullable=False, default=False)
    created_at = Column(DateTime, default=datetime.utcnow)
    updated_at = Column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
